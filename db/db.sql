...
create table bookings(id integer primary key autoincrement,user_id integer,date date,flight_id integer,status boolean default 1, frequent_flyer_discount real,class_id integer, flight_schedule_id integer,seat_no integer);
