...
create table flights(id integer primary key autoincrement,aircraft_type_id integer,price real,date varchar(30),from_date varchar(50),to_date varchar(50),counter varchar(30),departs varchar(30),arrives varchar(50));
