...
create table users(id integer primary key autoincrement,email varchar(20),password varchar(15),first_name varchar(20),last_name varchar(20),address varchar(40),passport_details varchar(30),state varchar(30),country varchar(30),is_admin boolean default 0);
...
create table aircraft_types(id integer primary key autoincrement,seat_capacity integer,first_class integer,second_class integer,third_class integer);
